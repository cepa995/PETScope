...
from petscope.constants import REFERENCE_REGIONS, PVC_SUPPORTED_METHODS, SUPPORTED_PHYSICAL_SPACES

def check_if_physical_space_is_supported(physical_space):
    """True if computation in specified space is supported, False otherwise"""
    return True if physical_space in SUPPORTED_PHYSICAL_SPACES else False
